...
<figure><img src="../.gitbook/assets/vory-grupo.jpg" alt="Trabalho forçado em gulag"><figcaption><p>As tatuagens dos vory contam sua história sem palavras</p></figcaption></figure>
...
O título de _vor_ (ladrão) não é autoproclamado. É **concedido** por outros vory em uma cerimônia formal chamada _skhodka_ (reunião). Para ser coroado, um candidato deve:
...
O código dos vory — chamado _ponyatiya_ (понятия, "entendimentos") — é um conjunto de regras que governam a vida de um ladrão coroado:
...
* **Advertência** (_preduprezhdenie_) — Para falhas menores
...
> _"O código não é escrito em papel. É escrito na pele, no sangue e na memória dos que sobrevivem."_

***

## A Guerra das Cadelas (Suchya Voyna)

<figure><img src="../.gitbook/assets/homem-epoca.jpg" alt="Prisioneiros em gulag russo"><figcaption><p>Os gulags do pós-guerra — cenário da guerra que dividiu os vory</p></figcaption></figure>
...
> _"Vor não é um título que se compra. É um peso que se carrega. Muitos querem o respeito — poucos aguentam o preço."_
